...
TERMINFO="/home/mankndn2/SPECTACLE/spectacle-0.02/ncurses/install/share/terminfo"
...
*.[0-9]*)
	...
	if test ! -f /home/mankndn2/SPECTACLE/spectacle-0.02/ncurses/ncurses-5.9/man_alias.sed ; then
cat >>/home/mankndn2/SPECTACLE/spectacle-0.02/ncurses/ncurses-5.9/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/mankndn2/SPECTACLE/spectacle-0.02/ncurses/ncurses-5.9/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /home/mankndn2/SPECTACLE/spectacle-0.02/ncurses/ncurses-5.9/man_alias.sed | sort -u`
	...
	sed	-f /home/mankndn2/SPECTACLE/spectacle-0.02/ncurses/ncurses-5.9/man_alias.sed \
		< $i >$TMP
